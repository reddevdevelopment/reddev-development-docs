...
* Usable pamphlets, paperwork, and bus pass document UI.
* Public transit with bus cutscenes and configurable stops.
* City Hall government hub interactions.
* Configurable car rental system with vehicle images.
* QBCore and Qbox support through the built-in bridge layer.
* Expandable config-first structure for future onboarding, reputation, jobs, and RP progression.

## Resource Name

The active resource name is:

```text
reddev_multicharacter
```

Make sure the folder name, `ensure` line, and any dependency references use the same name.
